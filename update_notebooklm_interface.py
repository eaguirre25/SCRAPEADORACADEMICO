  ...
  <div class="sidebar">
    <div class="sidebar-section">
      ...
      <div class="form-group">
        ...
        <input type="password" id="apiKeyInput" placeholder="Pegá tu clave de Gemini aquí">
...
function updateStatusUI(key) {
  ...
  tag.textContent = '🟢 Google Gemini 3.6 Conectado (2.124 Obras)';
  ...
  if (llmText) {
    ...
    finalHTML += `
      <div style="background:#1e1b4b;border:1px solid #4338ca;padding:14px 18px;border-radius:8px;margin-bottom:16px;font-size:0.9rem">
        ...
        Pegá tu clave de Google Gemini en el panel izquierdo y hacé clic en <b>💾 Conectar y Guardar Clave</b>.
      </div>
    `;
