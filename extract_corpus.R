...
drive_auth_configure(app = app)

# Construir token desde refresh_token
token <- gargle::oauth2.0_token(
  endpoint    = gargle::oauth_endpoints("google"),
  app         = app,
  scope       = "https://www.googleapis.com/auth/drive",
  credentials = list(refresh_token = refresh_token),
  cache       = FALSE
)
